    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <button onClick={onDelete}
          style={{ padding: "3px 8px", background: "none", border: "1px solid color-mix(in srgb, var(--error) 32%, transparent)", borderRadius: 4, color: "var(--error)", cursor: "pointer", fontSize: 11 }}>
           {t("i18n.delete")}
        </button>
      </div>
       ...
       <Field label={t("i18n.providerName")}>
        ...
        {editingName !== name && editingName.trim() && (
          <button onClick={() => onRename(editingName.trim())}
            style={{ marginTop: 4, padding: "3px 10px", background: "var(--accent)", border: "none", borderRadius: 4, color: "var(--text-inverse)", cursor: "pointer", fontSize: 11, alignSelf: "flex-start" }}>
             {t("i18n.rename")}
          </button>
        )}
      </Field>
      ...
      <div style={{ borderTop: "1px solid var(--border)", paddingTop: 14, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {discoveryState.phase === "error" && (
          <div style={{ padding: "7px 9px", border: "1px solid color-mix(in srgb, var(--error) 32%, transparent)", borderRadius: 5, color: "var(--error)", fontSize: 11, lineHeight: 1.4 }}>
          ...
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
              ...
              <button
                ...
                style={{ height: 28, padding: "0 11px", border: "none", borderRadius: 5, background: selectedCount ? "var(--accent)" : "var(--bg-panel)", color: selectedCount ? "var(--text-inverse)" : "var(--text-dim)", cursor: selectedCount ? "pointer" : "not-allowed", fontSize: 11, fontWeight: 600, whiteSpace: "nowrap" }}
              >
                {selectedCount
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {testSummary && (
            <span
              ...
              style={{
                ...
                height: 24,
                padding: "0 8px",
                border: `1px solid ${testState.phase === "error" ? "color-mix(in srgb, var(--error) 18%, transparent)" : testState.phase === "success" ? "color-mix(in srgb, var(--success) 18%, transparent)" : "var(--border)"}`,
                borderRadius: 4,
                background: testState.phase === "error" ? "color-mix(in srgb, var(--error) 12%, transparent)" : testState.phase === "success" ? "color-mix(in srgb, var(--success) 14%, transparent)" : "var(--bg-hover)",
                color: "var(--text)",
                fontSize: 11,
                display: "inline-flex",
                alignItems: "center",
          ...
          <button onClick={onDelete}
            style={{ height: 24, padding: "0 8px", background: "none", border: "1px solid color-mix(in srgb, var(--error) 32%, transparent)", borderRadius: 4, color: "var(--error)", cursor: "pointer", fontSize: 11, boxSizing: "border-box" }}>
             {t("i18n.remove")}
          </button>
        </div>
      </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              ...
              <button
                ...
                style={{ padding: "6px 12px", background: inputValue.trim() ? "var(--accent)" : "var(--bg-panel)", border: "none", borderRadius: 5, color: inputValue.trim() ? "var(--text-inverse)" : "var(--text-dim)", cursor: inputValue.trim() ? "pointer" : "not-allowed", fontSize: 12, fontWeight: 600, flexShrink: 0 }}
              >
                 {t("i18n.submit")}
              </button>
            </div>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {isWorking ? (
          ...
          <>
            <button
              onClick={handleLogin}
              style={{ padding: "5px 14px", background: "var(--accent)", border: "none", borderRadius: 5, color: "var(--text-inverse)", cursor: "pointer", fontSize: 12, fontWeight: 600 }}
            >
            ...
            {provider.loggedIn && (
              <button
                ...
                style={{ padding: "5px 12px", background: "none", border: "1px solid color-mix(in srgb, var(--error) 32%, transparent)", borderRadius: 5, color: "var(--error)", cursor: "pointer", fontSize: 12 }}
              >
                 {t("i18n.disconnect")}
              </button>
            )}
      ...
      {provider.configured && (
        <button
          ...
          style={{
            ...
            background: "none", border: "1px solid color-mix(in srgb, var(--error) 32%, transparent)",
